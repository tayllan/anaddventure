...
error:function(a,v,b){console.log(a)}});return!1});if("/"===q){var B=$("#top-all"),z=$("#top-today"),A=$(".top-tales");B.on("click",function(a){z.removeClass("active");B.addClass("active");$.ajax({type:"get",url:"/get_ten_best_tales",data:{timezone_offset:(new Date).getTimezoneOffset()},datatype:"json",success:function(a){A.find("div").remove();A.append(a)},error:function(a,v,b){console.log(a)}})});z.on("click",function(a){B.removeClass("active");z.addClass("active");$.ajax({type:"get",url:"/get_ten_best_daily_tales",
data:{timezone_offset:(new Date).getTimezoneOffset()},datatype:"json",success:function(a){A.find("div").remove();A.append(a)},error:function(a,v,b){console.log(a)}})});z.trigger("click")}if(-1!==q.indexOf("join")){var D=$(".login"),r=$(".signup"),G=r.find(".password-strength");r.find('input[name="signup-password"]').on("keyup",function(a){a=C(this.value);G.removeClass();switch(a){case 0:G.addClass("ui yellow label").html(m[g].TOO_WEAK);break;case 1:G.addClass("ui green label").html(m[g].WEAK);break;
case 2:G.addClass("ui blue label").html(m[g].GOOD);break;default:G.addClass("ui red label").html(m[g].STRONG)}});D.find("form").form({username:{identifier:"login-username",rules:p.username},password:{identifier:"login-password",rules:p.password}},{inline:!0,onSuccess:function(){var a=$(this).find('input[type="password"]')[0],d=(new jsSHA(a.value,"TEXT")).getHash("SHA-256","HEX");a.value=d;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=
a.url},error:function(a,d,b){w(a.responseJSON.error_list,D.find("h2"))}});return!1}});r.find("form").form({username:{identifier:"signup-username",rules:p.username},email:{identifier:"signup-email",rules:p.email},password:{identifier:"signup-password",rules:p.password},repeat_password:{identifier:"signup-repeat-password",rules:p.match("signup-password")}},{inline:!0,onSuccess:function(){var a=$(this).find('input[name="signup-password"]')[0],d=a.value,d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");
a.value=d;a=$(this).find('input[name="signup-repeat-password"]')[0];d=a.value;d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){w([a.message],r.find("h2"),!0)},error:function(a,d,b){w(a.responseJSON.error_list,r.find("h2"))}});return!1}})}if(-1!==q.indexOf("password_reset")){var J=$(".password-reset form");J.form({email:{identifier:"password-reset-email",rules:p.email}},{inline:!0,
onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){w([a.message],J.find("h1"),!0)},error:function(a,d,b){w(a.responseJSON.error_list,J.find("h1"))}});return!1}})}if(-1!==q.indexOf("change_password")){var M=$(".change-password form");M.form({password:{identifier:"change-password-new-password",rules:p.password},repeat_password:{identifier:"change-password-confirm-new-password",rules:p.password}},{inline:!0,onSuccess:function(){var a=
$(this).find('input[name="change-password-new-password"]')[0],d=a.value,d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;a=$(this).find('input[name="change-password-confirm-new-password"]')[0];d=a.value;d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,d,b){w(a.responseJSON.error_list,M.find("h1"))}});return!1}})}if(-1!==q.indexOf("profile")){var N=
/profile\/([^\/]+)/.exec(q)[1],E=$(".own"),F=$(".participated"),K=function(a,d,b){$.ajax({type:"get",url:"/get_rendered_own_tales",datatype:"json",data:{username:N,offset:a,search_string:d},success:function(d){E.empty().append(d);b||E.find("input")[0].focus();E.find("#pagination-buttons button").each(function(){parseInt(this.value,10)===parseInt(a,10)?$(this).addClass("disabled"):$(this).removeClass("disabled")})},error:function(a,d,b){console.log(a)}})},L=function(a,d,b){$.ajax({type:"get",url:"/get_rendered_participated_tales",
datatype:"json",data:{username:N,offset:a,search_string:d},success:function(d){F.empty().append(d);b||F.find("input")[0].focus();F.find("#pagination-buttons button").each(function(){parseInt(this.value,10)===parseInt(a,10)?$(this).addClass("disabled"):$(this).removeClass("disabled")})},error:function(a,d,b){console.log(a)}})};E.on("click",".own-pagination",function(a){a.preventDefault();K(this.value,E.find("input")[0].value);return!1});F.on("click",".participated-pagination",function(a){a.preventDefault();
L(this.value,F.find("input")[0].value);return!1});K(0,"",!0);L(0,"",!0);E.on("submit","form",function(a){a.preventDefault();K(0,$(this).find("input")[0].value);return!1});F.on("submit","form",function(a){a.preventDefault();L(0,$(this).find("input")[0].value);return!1})}var y=$(".profile");if(-1!==q.indexOf("update/")){var t=$(".button-update-profile");y.on("change",'input[name="update-avatar"]',function(a){if(a=this.files[0]){var d=y.find(".button-choose-file"),b=y.find(".label-choose-file");/\.(jpe?g|png|gif)$/i.test(a.name)?
1048576>a.size?(d.addClass("green").html(a.name),b.removeClass("ui red label").html("")):(this.value="",this.files=[],d.removeClass("green").html(m[g].ADD_AVATAR),b.addClass("ui red label").html(m[g].AVATAR_SIZE)):(this.value="",this.files=[],d.removeClass("green").html(m[g].ADD_AVATAR),b.addClass("ui red label").html(m[g].AVATAR_FORMAT))}});y.on("click",".button-choose-file",function(a){a.preventDefault();y.find('input[name="update-avatar"]').trigger("click");return!1});t.on("click",function(a){$.ajax({type:"get",
url:"/get_user_info",datatype:"json",data:{user_id:this.value},success:function(a){y.find("form").remove();y.append(a);y.find("form").form({name:{identifier:"update-name",rules:p.name},email:{identifier:"update-email",rules:p.email},email_visibility:{identifier:"update-email-visibility",rules:p.empty},biography:{identifier:"update-biography",rules:p.biography}},{inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=
a.url},error:function(a,d,b){w(a.responseJSON.error_list,y.find("h4"))}});return!1},onFailure:function(){return!1}})},error:function(a,b,c){console.log(a)}})});t.trigger("click");$(".button-update-password").on("click",function(a){$.ajax({type:"get",url:"/get_update_password_form",datatype:"json",data:{user_id:this.value},success:function(a){y.find("form").remove();y.append(a);var b=$(".password-strength");$('input[name="update-new-password"]').on("keyup",function(a){a=C(this.value);b.removeClass();
switch(a){case 0:b.addClass("ui yellow label").html(m[g].TOO_WEAK);break;case 1:b.addClass("ui green label").html(m[g].WEAK);break;case 2:b.addClass("ui blue label").html(m[g].GOOD);break;default:b.addClass("ui red label").html(m[g].STRONG)}});y.find("form").form({old_password:{identifier:"update-old-password",rules:p.password},new_password:{identifier:"update-new-password",rules:p.password},confirm_new_password:{identifier:"update-confirm-new-password",rules:p.match("update-new-password")}},{inline:!0,
onSuccess:function(){var a=$(this).find('input[name="update-old-password"]')[0],d=a.value,d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;a=$(this).find('input[name="update-new-password"]')[0];d=a.value;d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;a=$(this).find('input[name="update-confirm-new-password"]')[0];d=a.value;d=(new jsSHA(d,"TEXT")).getHash("SHA-256","HEX");a.value=d;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=
a.url},error:function(a,d,b){w(a.responseJSON.error_list,y.find("h4"))}});return!1},onFailure:function(){return!1}})},error:function(a,b,c){console.log(a)}})})}t=$(".upper-bar");if(0<t.length){var b=$("#to-fullscreen"),e=$("#fullscreen");t.on("submit",".form-unfollow",function(a){a.preventDefault();var d=$(".form-unfollow"),b=d[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){d.find("button")[0].innerHTML='<i class="unhide icon"></i>'+
m[g].WATCH+" "+a.followers;d.attr("action",b.replace("unfollow","follow"));d.attr("class","form-follow column")},error:function(a,d,b){console.log(a)}});return!1});t.on("submit",".form-follow",function(a){a.preventDefault();var d=$(".form-follow"),b=d[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){a.error?window.location=a.error:(d.find("button")[0].innerHTML='<i class="unhide icon"></i>'+m[g].UNWATCH+" "+a.followers,d.attr("action",
b.replace("follow","unfollow")),d.attr("class","form-unfollow column"))},error:function(a,d,b){console.log(a)}});return!1});t.on("submit",".form-unstar",function(a){a.preventDefault();var d=$(".form-unstar"),b=d[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){d.find("button")[0].innerHTML='<i class="star icon"></i>'+m[g].STAR+" "+a.stars;d.attr("action",b.replace("unstar","star"));d.attr("class","form-star column")},error:function(a,
d,b){console.log(a)}});return!1});t.on("submit",".form-star",function(a){a.preventDefault();var d=$(".form-star"),b=d[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){a.error?window.location=a.error:(d.find("button")[0].innerHTML='<i class="star icon"></i>'+m[g].UNSTAR+" "+a.stars,d.attr("action",b.replace("star","unstar")),d.attr("class","form-unstar column"))},error:function(a,d,b){console.log(a)}});return!1});-1!==q.indexOf("/fullscreen")&&
e.modal("show");b.on("click",function(a){e.modal("show")})}if(-1!==q.indexOf("update_tale")){var h=$(".main form");h.form({title:{identifier:"update-tale-title",rules:p.title},description:{identifier:"update-tale-description",rules:p.description},genres:{identifier:"update-tale-genres",rules:[{type:"empty_genres",prompt:m[g].EMPTY}]},license:{identifier:"update-tale-license",rules:p.checked},type:{identifier:"update-tale-type",rules:p.checked}},{rules:{empty_genres:function(){return 0<$('[name="update-tale-genres"]')[0].children.length}},
inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,b,c){w(a.responseJSON.error_list,h.find("h1"))}});return!1}});var t=$("#genres"),c=$('select[name="update-tale-genres"]'),f=$('select[name="available-genres"]');$("#available-genres").on("keyup",function(a){a=this.value;for(var b=f[0],c=0;c<b.length;c++)0>b[c].innerHTML.indexOf(a)?$(b[c]).attr("hidden","true"):$(b[c]).removeAttr("hidden")});
$("#taken-genres").on("keyup",function(a){a=this.value;for(var b=c[0],f=0;f<b.length;f++)0>b[f].innerHTML.indexOf(a)?$(b[f]).attr("hidden","true"):$(b[f]).removeAttr("hidden")});$("#add").on("click",function(a){a=f.find("option:selected");for(var b=0;b<a.length;b++)c.append(a[b])});$("#remove").on("click",function(a){a=c.find("option:selected");for(var b=0;b<a.length;b++)f.append(a[b])});t.on("dblclick",'select[name="update-tale-genres"] option',function(a){f.append(this);c.find("option").each(function(){$(this).attr("selected",
"selected")})});t.on("dblclick",'select[name="available-genres"] option',function(a){c.append(this)})}$(".results");if(-1!==q.indexOf("search")){$("#layout-search-bar").empty();$('input[name="content"]').focus();var n=$(".main-block"),l=1;$.ajax({type:"get",url:"/search_tales"+window.location.search,datatype:"json",success:function(a){n.empty().append(a)},error:function(a,b,c){console.log(a)}});var R=function(a,b){$.ajax({type:"get",url:a,datatype:"json",data:{"sort-value":b},success:function(b){n.empty().append(b);
l=a.indexOf("tales")},error:function(a,b,d){console.log(a)}})};$(".search-block").on("click",".search-tales, .search-users",function(a){a.preventDefault();R(this.href,1);return!1});n.on("change","#sort-bar",function(a){a="";a=0<=l?$(".search-tales")[0].href:$(".search-users")[0].href;R(a,$(this).find("option:selected")[0].value)})}var I=$(".contribution-requests");if(-1!==q.indexOf("contribution_requests")){var S=/contribution_requests\/([0-9]+)/.exec(window.location)[1],O=$(".o-c-r"),Q=$(".c-c-r");
O.on("click",function(a){1!==I.find(".open-contribution-requests").length&&(console.log("HERE"),O.addClass("active"),Q.removeClass("active"),$.ajax({type:"get",url:"/get_open_contribution_requests",datatype:"json",data:{tale_id:S},success:function(a){I.find(".closed-contribution-requests").remove();I.append(a)},error:function(a,b,c){console.log(a)}}))});O.trigger("click");Q.on("click",function(a){1!==I.find(".closed-contribution-requests").length&&(Q.addClass("active"),O.removeClass("active"),$.ajax({type:"get",
url:"/get_closed_contribution_requests",datatype:"json",data:{tale_id:S},success:function(a){I.find(".open-contribution-requests").remove();I.append(a)},error:function(a,b,c){console.log(a)}}))})}if(-1!==q.indexOf("create")){var k=$(".create form");k.form({title:{identifier:"create-title",rules:p.title},description:{identifier:"create-description",rules:p.description},genres:{identifier:"create-genres",rules:[{type:"empty_genres",prompt:m[g].EMPTY}]},license:{identifier:"create-license",rules:p.checked},
type:{identifier:"create-type",rules:p.checked}},{rules:{empty_genres:function(){return 0<$('[name="create-genres"]')[0].children.length}},inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,b,c){w(a.responseJSON.error_list,k.find("h1"))}});return!1}});var t=$("#genres"),u=$('select[name="create-genres"]'),f=$('select[name="available-genres"]');$("#available-genres").on("keyup",
function(a){a=this.value;for(var b=f[0],c=0;c<b.length;c++)0>b[c].innerHTML.indexOf(a)?$(b[c]).attr("hidden","true"):$(b[c]).removeAttr("hidden")});$("#taken-genres").on("keyup",function(a){a=this.value;for(var b=u[0],c=0;c<b.length;c++)0>b[c].innerHTML.indexOf(a)?$(b[c]).attr("hidden","true"):$(b[c]).removeAttr("hidden")});$("#add").on("click",function(a){a=f.find("option:selected");for(var b=0;b<a.length;b++)u.append(a[b])});$("#remove").on("click",function(a){a=u.find("option:selected");for(var b=
0;b<a.length;b++)f.append(a[b])});t.on("dblclick",'select[name="create-genres"] option',function(a){f.append(this);u.find("option").each(function(){$(this).attr("selected","selected")})});t.on("dblclick",'select[name="available-genres"] option',function(a){u.append(this)})}if(-1!==q.indexOf("contribute")){var P=$(".contribute-form");tinymce.init({selector:'textarea[name="contribute-content"]'});P.form({title:{identifier:"contribute-title",rules:p.title}},{inline:!0,onSuccess:function(){$.ajax({type:this.method,
url:this.action,data:{"contribute-title":P.find('[name="contribute-title"]')[0].value,"contribute-content":tinymce.get("contribute-content").getContent(),_csrf_token:P.find('[name="_csrf_token"]')[0].value},success:function(a){window.location=a.url},error:function(a,b,c){w(a.responseJSON.error_list,P.find("h1"))}});return!1}})}if(-1!==q.indexOf("settings"))$("#form-delete").on("submit",function(a){a.preventDefault();a=$(this).find("button")[0].value;var b=prompt(m[g].DELETE_MODAL_MESSAGE);b&&(b===
a?$.ajax({type:this.method,url:this.action,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,b,c){console.log(a)}}):($(this).find("div").remove(),$(this).append('<div class="ui red message">'+m[g].DELETE_MODAL_WRONG_TITLE+"</div>")));return!1});if(-1!==q.indexOf("contact")){var x=$(".contact-form");x.form({name:{identifier:"contact-name",rules:p.name},email:{identifier:"contact-email",rules:p.email},message:{identifier:"contact-message",
rules:p.empty}},{inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){var b=$("#received-message");b.html(a);b.addClass("ui positive message")},error:function(a,b,c){w(a.responseJSON.error_list,x.find("h1"))}});return!1}})}});"use strict";
