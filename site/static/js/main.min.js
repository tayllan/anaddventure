...
c=a.value;c=(new jsSHA(c,"TEXT")).getHash("SHA-256","HEX");a.value=c;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,c,b){v(a.responseJSON.error_list,L.find("h1"))}});return!1}})}if(-1!==r.indexOf("profile")){var M=/profile\/([^\/]+)/.exec(r)[1],D=$(".own"),E=$(".participated"),I=function(a,c,b){$.ajax({type:"get",url:"/get_rendered_own_tales",datatype:"json",data:{username:M,offset:a,search_string:c},
success:function(c){D.empty().append(c);b||D.find("input")[0].focus();D.find("#pagination-buttons button").each(function(){parseInt(this.value,10)===parseInt(a,10)?$(this).addClass("disabled"):$(this).removeClass("disabled")})},error:function(a,c,b){console.log(a)}})},J=function(a,c,b){$.ajax({type:"get",url:"/get_rendered_participated_tales",datatype:"json",data:{username:M,offset:a,search_string:c},success:function(c){E.empty().append(c);b||E.find("input")[0].focus();E.find("#pagination-buttons button").each(function(){parseInt(this.value,
10)===parseInt(a,10)?$(this).addClass("disabled"):$(this).removeClass("disabled")})},error:function(a,c,b){console.log(a)}})};D.on("click",".own-pagination",function(a){a.preventDefault();I(this.value,D.find("input")[0].value);return!1});E.on("click",".participated-pagination",function(a){a.preventDefault();J(this.value,E.find("input")[0].value);return!1});I(0,"",!0);J(0,"",!0);D.on("submit","form",function(a){a.preventDefault();I(0,$(this).find("input")[0].value);return!1});E.on("submit","form",
function(a){a.preventDefault();J(0,$(this).find("input")[0].value);return!1})}var w=$(".profile");if(-1!==r.indexOf("update/")){var q=$(".button-update-profile");w.on("change",'input[name="update-avatar"]',function(a){if(a=this.files[0]){var c=w.find(".button-choose-file"),b=w.find(".label-choose-file");/\.(jpe?g|png|gif)$/i.test(a.name)?1048576>a.size?(c.addClass("green").html(a.name),b.removeClass("ui red label").html("")):(this.value="",this.files=[],c.removeClass("green").html(n[m].ADD_AVATAR),
b.addClass("ui red label").html(n[m].AVATAR_SIZE)):(this.value="",this.files=[],c.removeClass("green").html(n[m].ADD_AVATAR),b.addClass("ui red label").html(n[m].AVATAR_FORMAT))}});w.on("click",".button-choose-file",function(a){a.preventDefault();w.find('input[name="update-avatar"]').trigger("click");return!1});q.on("click",function(a){$.ajax({type:"get",url:"/get_user_info",datatype:"json",data:{user_id:this.value},success:function(a){w.find("form").remove();w.append(a);w.find("form").form({name:{identifier:"update-name",
rules:p.name},email:{identifier:"update-email",rules:p.email},email_visibility:{identifier:"update-email-visibility",rules:p.empty},biography:{identifier:"update-biography",rules:p.biography}},{inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,c,b){v(a.responseJSON.error_list,w.find("h4"))}});return!1},onFailure:function(){return!1}})},error:function(a,b,d){console.log(a)}})});
q.trigger("click");$(".button-update-password").on("click",function(a){$.ajax({type:"get",url:"/get_update_password_form",datatype:"json",data:{user_id:this.value},success:function(a){w.find("form").remove();w.append(a);var b=$(".password-strength");$('input[name="update-new-password"]').on("keyup",function(a){a=B(this.value);b.removeClass();switch(a){case 0:b.addClass("ui yellow label").html(n[m].TOO_WEAK);break;case 1:b.addClass("ui green label").html(n[m].WEAK);break;case 2:b.addClass("ui blue label").html(n[m].GOOD);
break;default:b.addClass("ui red label").html(n[m].STRONG)}});w.find("form").form({old_password:{identifier:"update-old-password",rules:p.password},new_password:{identifier:"update-new-password",rules:p.password},confirm_new_password:{identifier:"update-confirm-new-password",rules:p.match("update-new-password")}},{inline:!0,onSuccess:function(){var a=$(this).find('input[name="update-old-password"]')[0],c=a.value,c=(new jsSHA(c,"TEXT")).getHash("SHA-256","HEX");a.value=c;a=$(this).find('input[name="update-new-password"]')[0];
c=a.value;c=(new jsSHA(c,"TEXT")).getHash("SHA-256","HEX");a.value=c;a=$(this).find('input[name="update-confirm-new-password"]')[0];c=a.value;c=(new jsSHA(c,"TEXT")).getHash("SHA-256","HEX");a.value=c;$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,c,b){v(a.responseJSON.error_list,w.find("h4"))}});return!1},onFailure:function(){return!1}})},error:function(a,b,d){console.log(a)}})})}q=$(".upper-bar");
0<q.length&&(q.on("submit",".form-unfollow",function(a){a.preventDefault();var c=$(".form-unfollow"),b=c[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){c.find("button")[0].innerHTML='<i class="unhide icon"></i>'+n[m].WATCH+" "+a.followers;c.attr("action",b.replace("unfollow","follow"));c.attr("class","form-follow")},error:function(a,c,b){console.log(a)}});return!1}),q.on("submit",".form-follow",function(a){a.preventDefault();
var c=$(".form-follow"),b=c[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){a.error?window.location=a.error:(c.find("button")[0].innerHTML='<i class="unhide icon"></i>'+n[m].UNWATCH+" "+a.followers,c.attr("action",b.replace("follow","unfollow")),c.attr("class","form-unfollow"))},error:function(a,c,b){console.log(a)}});return!1}),q.on("submit",".form-unstar",function(a){a.preventDefault();var c=$(".form-unstar"),b=c[0].action;
$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,success:function(a){c.find("button")[0].innerHTML='<i class="star icon"></i>'+n[m].STAR+" "+a.stars;c.attr("action",b.replace("unstar","star"));c.attr("class","form-star")},error:function(a,c,b){console.log(a)}});return!1}),q.on("submit",".form-star",function(a){a.preventDefault();var c=$(".form-star"),b=c[0].action;$.ajax({type:"post",url:b,datatype:"json",data:new FormData(this),processData:!1,contentType:!1,
...
prompt:n[m].EMPTY}]},license:{identifier:"update-tale-license",rules:p.checked},type:{identifier:"update-tale-type",rules:p.checked}},{rules:{empty_genres:function(){return 0<$('[name="update-tale-genres"]')[0].children.length}},inline:!0,onSuccess:function(){$.ajax({type:this.method,url:this.action,data:new FormData(this),processData:!1,contentType:!1,success:function(a){window.location=a.url},error:function(a,c,d){v(a.responseJSON.error_list,b.find("h1"))}});return!1}});var q=$("#genres"),e=$('select[name="update-tale-genres"]'),
f=$('select[name="available-genres"]');$("#available-genres").on("keyup",function(a){a=this.value;for(var c=f[0],b=0;b<c.length;b++)0>c[b].innerHTML.indexOf(a)?$(c[b]).attr("hidden","true"):$(c[b]).removeAttr("hidden")});$("#taken-genres").on("keyup",function(a){a=this.value;for(var c=e[0],b=0;b<c.length;b++)0>c[b].innerHTML.indexOf(a)?$(c[b]).attr("hidden","true"):$(c[b]).removeAttr("hidden")});$("#add").on("click",function(a){a=f.find("option:selected");for(var b=0;b<a.length;b++)e.append(a[b])});
$("#remove").on("click",function(a){a=e.find("option:selected");for(var b=0;b<a.length;b++)f.append(a[b])});q.on("dblclick",'select[name="update-tale-genres"] option',function(a){f.append(this);e.find("option").each(function(){$(this).attr("selected","selected")})});q.on("dblclick",'select[name="available-genres"] option',function(a){e.append(this)})}$(".results");if(-1!==r.indexOf("search")){$("#layout-search-bar").empty();$('input[name="content"]').focus();var d=$(".main-block"),h=1;$.ajax({type:"get",
url:"/search_tales"+window.location.search,datatype:"json",success:function(a){d.empty().append(a)},error:function(a,b,d){console.log(a)}});var l=function(a,b){$.ajax({type:"get",url:a,datatype:"json",data:{"sort-value":b},success:function(b){d.empty().append(b);h=a.indexOf("tales")},error:function(a,b,c){console.log(a)}})};$(".search-block").on("click",".search-tales, .search-users",function(a){a.preventDefault();l(this.href,1);return!1});d.on("change","#sort-bar",function(a){a="";a=0<=h?$(".search-tales")[0].href:
$(".search-users")[0].href;l(a,$(this).find("option:selected")[0].value)})}var k=$(".contribution-requests");if(-1!==r.indexOf("contribution_requests")){var P=/contribution_requests\/([0-9]+)/.exec(window.location)[1],N=$(".o-c-r"),O=$(".c-c-r");N.on("click",function(a){1!==k.find(".open-contribution-requests").length&&(console.log("HERE"),N.addClass("active"),O.removeClass("active"),$.ajax({type:"get",url:"/get_open_contribution_requests",datatype:"json",data:{tale_id:P},success:function(a){k.find(".closed-contribution-requests").remove();
