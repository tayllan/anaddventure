...
STRINGS = {
	'en': {
		...
		'INVALID_USER': 'Invalid Username and/or Password',
	...
	'pt': {
		...
		'UPDATE': 'Atualizar',
		'NO_CLOSED_CONTRIBUTIONS_TALE': 'Não há Pedidos Fechados de Colaborações neste Conto',
		'NO_OPEN_CONTRIBUTIONS_TALE': 'Não há Pedidos Abertos de Colaborações neste Conto',
		...
		'TALES_CONTRIBUTED_TO': 'Contos com os quais colaborei',
		...
		'INVALID_USER': 'Username e/ou Senha inválidos',
